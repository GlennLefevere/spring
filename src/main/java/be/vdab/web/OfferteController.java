...
public class OfferteController {
	...
	String createForm1Naar2(@Validated(Offerte.Stap1.class) @ModelAttribute("offerte") Offerte offerte, BindingResult bindingResult) {
		return bindingResult.hasErrors() ? STAP1_VIEW : STAP2_VIEW;
	}

	@RequestMapping(method = RequestMethod.POST, params = "van2naar1")
	String createForm2Naar1(@ModelAttribute("offerte") Offerte offerte) {
		return STAP1_VIEW;
	}

	@RequestMapping(method = RequestMethod.POST, params = "bevestigen")
	String create(@Validated(Offerte.Stap2.class) @ModelAttribute("offerte") Offerte offerte, BindingResult bindingResult, SessionStatus sessionStatus) {
